...
const AddProducts = (value,imagePath,multipleImagePath )=> {
    ...
    return new Promise((resolve,reject)=>{
          ...
          if(value.car_rental_company_id !== "1") {
              ...
              console.log(value);
              DealerModel.findOneAndUpdate({_id: mongoose.Types.ObjectId(value.car_rental_company_id)}, {
                  $inc: {total_cars: 1, total_active: 1,}
              }, {new: true}).then(dealerData => {


                  addData(value, imagePath, multipleImagePath, resolve, reject, dealerData.car_rental_company_name)
              });
          }else{
...
const addData = (value,imagePath,multipleImagePath,resolve,reject,car_rental_company_name)=>{
